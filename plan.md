...
상태: 구현 중 · 2026-09-07 · 설계 책임/통합 검증: Main(Codex)
...
| 단계 | 소유자 | 완료 조건 | 상태 |
|---|---|---|---|
| 설계 계약/하네스 | Main | plan·AGENTS·API 계약·검증 명령 | 진행 중 |
| Rust/Neo4j 핵심 | Opus | 불변 기록·패키지·시점·검색·복구 API와 테스트 | 대기 |
| 2D 화면 | Terra | 고정 API 계약에 연결된 탐색/입력/검토 | 대기 |
| Docker/통합 검증 | Main | 실제 단일 이미지 및 재시작·복원 테스트 | 대기 |
| 독립 수용 검토 | Sol/Main | 주요 불변 조건 검토, 발견 결함 해결 | 대기 |
