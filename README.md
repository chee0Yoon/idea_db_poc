...
> 기능 검증 기준: 2026-09-07, `13c9b8b`. Project·Schema·Core의 자체 목표, AI 예상 달성률, 근거 링크, 전체 버전 계보 비교와 AI 요약 표시가 구현되어 있습니다. 예상 달성률은 로컬 AI가 현재 기획·구현·검증 근거를 기준으로 작성한 이정표 추정이며, 실제 성능 측정값이나 성공 확률과 분리됩니다.
